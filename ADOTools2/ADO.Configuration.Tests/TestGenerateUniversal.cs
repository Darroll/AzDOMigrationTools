...
{
    [TestClass]
    public class TestGenerateUniversal
    {
        ...
        public static void MyClassInitialize(TestContext testContext)
        {
            ...
            int projectNumber = 8;
            destinationProject = $"UniversalXML_{projectNumber.ToString().PadLeft(2, '0')}";
            destinationProjectProcessName = "MigrateableUniversal";
            //used for Bulk Import
            destinationProcessTypeName = "CMMI";
            defaultTeamName = $"{destinationProject} Team";
            description = "One PROCESS to Rule Them All";
            reflectedWorkItemId = "Custom.ReflectedWorkItemId";
            ...
            root = SimpleMutableBusinessNodeNode.LoadFromJson(@"..\..\Input\businessNodeFromCsv2.json");
            //modify root Name
            root.Item.Name = destinationProject;
            //back to dataNode
            BusinessNodeDataNode businessNodeDataNode = root.ToBusinessNodeDataNodeRecursive();
            //save back
            root.SaveToJson(@"..\..\Input\businessNodeFromCsvNEW2.json");
        }
        ...
        public void TestGenerateBusinessNodeFromCsv()
        {
            ...
            BusinessNode businessNode
                = BusinessNode.LoadFromCsv(@"..\..\Input\businessHierarchyCsv2.csv",
                    "UniversalXML_01", true, BusinessNodeType.Program, defaultPortfolioCadences,
            ...
            File.WriteAllText(@"..\..\Output\businessNodeFromCsv2.json", json);
