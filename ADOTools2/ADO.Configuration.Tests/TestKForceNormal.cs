...
namespace ADO.Configuration.Tests
{
    ...
    public class TestKForceNormal
    {
        ...
        public static void MyClassInitialize(TestContext testContext)
        {
            ...
            destinationCollection = "processdevopsabcs";
            int projectNumber = 3;
            destinationProject = $"FlatProcessPOC_{projectNumber.ToString().PadLeft(2, '0')}";
            destinationProjectProcessName = "MigrateableAgile";
